...
/**
 * Created by 我的样子平平无奇 on 2017/12/25 09:16.
 * Email: 2256669598@qq.com
 */

class AnnotatedClass {
    private static class TypeUtil {
        static final ClassName BINDER = ClassName.get("ylj.butf_api", "ViewBinder");
        static final ClassName PROVIDER = ClassName.get("ylj.butf_api", "ViewFinder");
    }
